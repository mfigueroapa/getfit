          ...
          <List className="display-workout__list">
            {workout && workoutExc.length == count ? (
              <>
                  ...
                  <List.Item key={index}>
                    {item.set ? (
                      <div className="list-item-set">
                        <p>
                          {item.set} <span>Repeat {workout.repeat} times</span>
                        </p>
                      </div>
                    ) : item.exercise ? (
                      <Row
                      ...
                      >
                        <Col span={24}>
                          <Row>
                            ...
                            <Col
                              span={16}
                              className="list-item-exercise__content"
                            >
                ...
                <br />
                <Button
                  onClick={() => handleAddToFav(workout)}
                  type="primary"
                  block
                  size="middle"
                  htmlType="submit"
