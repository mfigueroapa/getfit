...
function Home() {
  return (
    <div id="home">
      ...
      <Row>
        <Col span={24}>
          <Title level={4}>Best Training</Title>
        </Col>
      </Row>
          ...
          <Card>
            ...
            <div className="card-content">
              ...
              <p className="card-text">
                feel better emotionally and phsically with a few minuts of
                exercise a day
              </p>
            </div>
          </Card>
        ...
        <Col span={6}>
          <Card>
            ...
            <div className="card-content">
              ...
              <p className="card-text">
                Feel better with a bit of exercise, just 20min a day
              </p>
            </div>
          </Card>
        </Col>
        <Col span={6}>
          <Card>
            ...
            <div className="card-content">
              ...
              <p className="card-text">
                No need of a gym or a big space to stay Healthy
              </p>
            </div>
          </Card>
        </Col>
      ...
      <Row className="section section-inverse promo-2">
        <Col span={24}>
          ...
          <p>
            Prepare your workouts, get followers and help people to get
            healthier
          </p>
        </Col>
      </Row>
